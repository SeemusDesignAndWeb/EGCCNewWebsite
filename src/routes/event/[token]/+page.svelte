<script>
	...
	// Get selected occurrence details (from upcoming signup list or full list)
					...
					{#if event.enableSignup}
						<div class="bg-white shadow rounded-lg p-6">
							...
							{#if upcomingOccurrencesForSignup.length === 0}
								<p class="text-gray-600 mb-4">There are no dates available to sign up for from today onwards. All occurrences for this event have passed.</p>
							{:else}
						<form 
							method="POST" 
							action="?/signup" 
