					...
					<div class="bg-gray-50 rounded-lg p-3">
						...
						<div class="flex flex-col gap-2">
							<button
								...
								class="w-full bg-hub-green-600 text-white px-2.5 py-1.5 rounded-md hover:bg-hub-green-700 text-xs whitespace-nowrap flex items-center justify-center gap-1.5"
							>
							...
							<button
								...
								class="w-full bg-hub-blue-600 text-white px-2.5 py-1.5 rounded-md hover:bg-hub-blue-700 text-xs whitespace-nowrap flex items-center justify-center gap-1.5"
							>
								<svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
