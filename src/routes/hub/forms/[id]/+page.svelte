	...
	<div class="bg-white shadow rounded-lg p-6 mb-6">
		<div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
			...
			<div class="flex flex-wrap gap-2">
				...
				{:else}
					<a href="/forms/{form.id}" target="_blank" class="bg-theme-button-1 text-white px-2.5 py-1.5 rounded-md hover:opacity-90 text-xs">
				...
				<div class="border border-gray-200 rounded-lg p-4 mb-4">
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
						...
						<div>
							...
							<input type="text" bind:value={fieldForm.name} class="w-full rounded-md border border-gray-500 shadow-sm focus:border-theme-button-2 focus:ring-theme-button-2 py-3 px-4" />
						</div>
						<div>
						...
						<div class="mt-4">
							...
							<div class="flex gap-2 mb-2">
								<input
									...
									class="flex-1 rounded-md border border-gray-500 shadow-sm focus:border-theme-button-2 focus:ring-theme-button-2"
