...
<div class="bg-white shadow rounded-lg p-6">
	<div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
		...
		<div class="flex flex-wrap gap-2">
			<a href="/hub/videos" class="bg-theme-button-3 text-white px-2.5 py-1.5 rounded-md hover:opacity-90 text-xs">
				Back
			</a>
			<button 
				type="button"
			...
			<button type="submit" form="video-edit-form" class="bg-theme-button-2 text-white px-2.5 py-1.5 rounded-md hover:opacity-90 text-xs">
