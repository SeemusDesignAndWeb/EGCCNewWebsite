				...
				<div class="flex flex-wrap gap-2">
					{#if editing}
						<button
							...
							class="bg-hub-green-600 hover:bg-hub-green-700 text-white px-2 py-1.5 sm:px-4 sm:py-2 rounded-md transition-colors text-sm sm:text-base font-medium border border-hub-green-500/50 flex items-center gap-1.5 sm:gap-2"
						>
						...
						<button
							...
							class="bg-hub-blue-600 hover:bg-hub-blue-700 text-white px-2 py-1.5 sm:px-4 sm:py-2 rounded-md transition-colors text-sm sm:text-base font-medium border border-hub-blue-500/50 flex items-center gap-1.5 sm:gap-2"
						>
							<svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					{:else}
						<button
							...
							class="bg-hub-yellow-500/80 hover:bg-hub-yellow-600/90 text-white px-2 py-1.5 sm:px-4 sm:py-2 rounded-md transition-colors text-sm sm:text-base font-medium border border-hub-yellow-400/50 flex items-center gap-1.5 sm:gap-2"
						>
							<svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						...
						<a href="/hub/newsletters/{newsletter.id}/preview" class="bg-hub-red-500/80 hover:bg-hub-red-600/90 text-white px-2 py-1.5 sm:px-4 sm:py-2 rounded-md transition-colors text-sm sm:text-base font-medium border border-hub-red-400/50 flex items-center gap-1.5 sm:gap-2">
							<svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						...
						<a href="/hub/newsletters/{newsletter.id}/export-pdf" target="_blank" class="bg-hub-red-600 hover:bg-hub-red-700 text-white px-2 py-1.5 sm:px-4 sm:py-2 rounded-md transition-colors text-sm sm:text-base font-medium border border-hub-red-500/50 flex items-center gap-1.5 sm:gap-2">
							<svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						...
						<a href="/hub/newsletters/{newsletter.id}/send" class="bg-white/20 hover:bg-white/30 text-white px-2 py-1.5 sm:px-4 sm:py-2 rounded-md transition-colors text-sm sm:text-base font-medium border border-white/30 flex items-center gap-1.5 sm:gap-2">
							<svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
				...
				<div class="flex gap-2">
					{#if editing}
						<button
							...
							class="bg-white/20 hover:bg-white/30 text-white px-2 py-1.5 sm:px-4 sm:py-2 rounded-md transition-colors text-sm sm:text-base font-medium border border-white/30 flex items-center gap-1.5 sm:gap-2"
						>
							<svg class="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					<button
						...
						class="bg-hub-red-500/80 hover:bg-hub-red-600/90 text-white px-2 py-1.5 sm:px-4 sm:py-2 rounded-md transition-colors text-sm sm:text-base font-medium border border-hub-red-400/50 flex items-center gap-1.5 sm:gap-2"
					>
						<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
