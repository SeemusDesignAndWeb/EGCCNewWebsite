...
<div class="mb-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
	...
	<div class="flex flex-wrap gap-2">
		<a href="/hub/rotas/invite" class="bg-hub-blue-600 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-md hover:bg-hub-blue-700 text-sm sm:text-base">
			Bulk Invite
		</a>
		<a href="/hub/rotas/new" class="bg-hub-green-600 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-md hover:bg-hub-green-700 text-sm sm:text-base">
			New Rota
		</a>
	</div>
</div>
